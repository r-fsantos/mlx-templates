...
** All the key-code example other than below is described on the site:
*/
#define KEY_ESC	53
#define KEY_Q	12
#define KEY_W	13
...
/*
** Since key_press() can receive only one argument, all of them
** should be gathred in one structure.
...
// only param->x will be used on this program.
